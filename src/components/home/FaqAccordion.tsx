...
const faqs = [
  ...
  },
  {
    ...
    a: "أبداً! اللصقة تظل تعمل معك مدى الحياة أينما وضعتها. وفي حال قمت بتغيير قائمة الأسعار أو تعديل بياناتك، كل ما عليك هو التواصل معنا وسنقوم بتحديثها لك فوراً وعن بُعد مجاناً دون الحاجة لشراء لصقة جديدة.",
  },
];

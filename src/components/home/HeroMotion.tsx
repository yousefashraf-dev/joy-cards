...
export default function HeroMotion() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-gold/5 rounded-full blur-3xl" />
      <div className="absolute bottom-1/3 right-1/3 w-80 h-80 bg-gold/10 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
        ...
        <div className="flex items-center justify-center gap-8 md:gap-16 mb-12 h-64">
          ...
          >
            <div className="absolute inset-0 rounded-full bg-gold/20 animate-pulse shadow-[0_0_60px_rgba(212,175,55,0.3)]" />
            <div className="absolute inset-2 rounded-full bg-gradient-to-br from-gold to-gold-dark flex items-center justify-center shadow-[0_0_40px_rgba(212,175,55,0.5)]">
          ...
          >
            <svg viewBox="0 0 100 200" className="w-full h-full drop-shadow-[0_0_30px_rgba(212,175,55,0.2)]">
              <rect x="5" y="5" width="90" height="190" rx="12" fill="#1A1A1A" stroke="rgba(212,175,55,0.3)" strokeWidth="2" />
              ...
              >
                ...
                <circle cx="72" cy="23" r="2" fill="rgba(212,175,55,0.6)" />
                {/* App icon */}
                <circle cx="50" cy="55" r="12" fill="rgba(212,175,55,0.2)" stroke="rgba(212,175,55,0.4)" strokeWidth="1" />
                ...
                />
                <text x="50" y="108" textAnchor="middle" fill="rgba(212,175,55,0.6)" fontSize="5" fontFamily="sans-serif">NFC</text>
                {/* Bottom bar */}
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full glass bg-gold/10 border border-gold/30 shadow-[0_0_30px_rgba(212,175,55,0.2)]">

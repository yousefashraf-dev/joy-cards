...
const batmanPositions = [
  { top: "5%", left: "5%", size: "w-14 h-14", rotate: "-rotate-12" },
  { top: "15%", right: "8%", size: "w-10 h-10", rotate: "rotate-25" },
  { top: "40%", left: "-5%", size: "w-20 h-20", rotate: "rotate-45" },
  { top: "55%", right: "-3%", size: "w-16 h-16", rotate: "-rotate-8" },
  { top: "75%", left: "10%", size: "w-12 h-12", rotate: "rotate-15" },
  { top: "85%", right: "12%", size: "w-14 h-14", rotate: "-rotate-20" },
  { top: "60%", left: "20%", size: "w-8 h-8", rotate: "rotate-35" },
  { top: "10%", left: "40%", size: "w-6 h-6", rotate: "-rotate-5" },
  { top: "45%", right: "25%", size: "w-7 h-7", rotate: "rotate-60" },
  { top: "25%", left: "30%", size: "w-9 h-9", rotate: "-rotate-40" },
];
...
export default function BatmanProfile({ name, logo, buttons, iconMap }: ThemeProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-950 via-black to-neutral-950 flex flex-col items-center justify-center p-6 relative overflow-hidden">
      {/* Scattered bat logos in background */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {batmanPositions.map((pos, i) => (
          <img
            key={i}
            src="/Batman-removebg-preview.png"
            alt=""
            className={`absolute opacity-20 ${pos.size} ${pos.rotate} filter brightness-0 invert-[0.85] sepia-[1] saturate-[5000%] hue-rotate-[15deg]`}
            style={{ top: pos.top, left: pos.left, right: pos.right as string | undefined } as React.CSSProperties}
          />
        ))}
      </div>
        ...
        <div className="rounded-2xl p-6 text-center bg-black/60 backdrop-blur-xl border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex justify-center mb-3">
            <img
              src="/Batman-removebg-preview.png"
              alt=""
              className="w-12 h-12 object-contain filter brightness-0 invert-[0.85] sepia-[1] saturate-[5000%] hue-rotate-[15deg] drop-shadow-[0_0_8px_rgba(250,204,21,0.7)]"
            />
          </div>

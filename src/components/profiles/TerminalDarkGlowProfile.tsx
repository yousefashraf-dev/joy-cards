              ...
              {buttons.map((btn) => {
                ...
                return (
                  <motion.a
                    ...
                    className="flex items-center justify-between gap-3 w-full p-3 rounded-xl bg-white/[0.03] backdrop-blur-md border border-cyan/30 text-white/90 hover:border-cyan/60 hover:shadow-[0_0_20px_rgba(0,243,255,0.25)] hover:bg-white/[0.06] transition-all duration-300 group"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-cyan/15 flex items-center justify-center group-hover:bg-cyan/25 transition-colors shrink-0">
                      <Icon className="w-5 h-5 text-cyan" />
                    </div>
                    <span className="flex-1 text-center text-xs font-mono font-bold tracking-wider">{btn.label}</span>
